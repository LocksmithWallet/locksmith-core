...
// attempts to borrow a key without sufficient key balance.
error InsufficientKeys();

// Transactions will revert with this message when an operator
// attempts to borrow a key and it isn't returned when
// the transaction completes.
error KeyNotReturned();

// Transactions will revert with this message when an operator
// attempts to borrow a key and the transaction results in
// the message sender losing the key required for the loan.
error CallerKeyStripped();
